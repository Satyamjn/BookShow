...
const handleSubmit=async(e)=>{
    try{
        await axios.post('http://localhost:4000/send-otp',{phoneNumber:formData})
            ...
            <div className='bg-[#55555591] h-full w-full rounded fixed z-10' style={loginTogle ? { display: 'block' } : { display: 'none' }}>
                <div className='w-[420px] h-[550px] p-5 bg-white fixed left-[35%] translate-y-28 rounded flex flex-col items-center'>
                    ...
                    <div className='flex items-center gap-10 text-[#555]'>
                        ...
                        }} type='tel' className=' text-[#555555ba] w-[200px] border-0 border-b border-[#555] rounded-none ml-[-20px]' placeholder='e:g  +91 8080808080......' />
                    </div>
                    <div className='mt-12'>
                        <button onClick={handleSubmit} className='w-[300px]'>Continue</button>
                    </div>
                </div>
            </div>
